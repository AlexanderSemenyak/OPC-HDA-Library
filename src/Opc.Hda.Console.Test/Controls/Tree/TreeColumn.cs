...
using Opc.Hda.Controls.Internal;
...
namespace Opc.Hda.Controls.Tree
{
	...
	public class TreeColumn : Component
	{
        ...
        public TreeColumn(string header, int width): this(header,header,width)
		{
		}

        public TreeColumn(string header, string fieldName, int width)
        {
            _header = header;
            _width = width;
