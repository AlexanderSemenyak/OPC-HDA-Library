...
namespace Opc.Hda.Controls.Tree.NodeControls
{
	public abstract class BindableControl : NodeControl
	{
		...
		public virtual object GetValue(TreeNodeAdv node)
		{
			if (VirtualMode)
			{
				NodeControlValueEventArgs args = new NodeControlValueEventArgs(this, node);
				OnValueNeeded(args);
				return args.Value;
			}
			else
        ...
        /// <summary>
        /// Получить по этому событию значение своими средствами
        /// </summary>
        ...
        /// <summary>
        /// Поместить по этому событию значение своими средствами в свой источник
        /// </summary>
